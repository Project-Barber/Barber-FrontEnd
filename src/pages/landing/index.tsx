...
import BarbersCard from '@/components/custom-componets/barbersCard';
...
const Landing: React.FC = () => {
    return (
      ...
      <div><section className="py-16 px-6 md:px-12 bg-gray-50">
      <div className="text-center mb-14">
        <h2 className="text-3xl md:text-4xl font-bold mb-2">Conheça nossos barbeiros</h2>
        <p className="text-gray-500 text-base md:text-lg">
          Profissionais qualificados prontos para atender você
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 gap-x-8 gap-y-12 max-w-7xl mx-auto">
        <BarbersCard name="Rafael Oliveira" />
        <BarbersCard name="José Ferreira" />
        <BarbersCard name="Carlos Silva" />
      </div>
    </section></div>
